...
Rules:
- The narration is FIXED and already chosen — do NOT restate or change it. Your job is purely the visuals that play WHILE it is spoken. Synchronize visual actions to the narration's sync cues.
